...
const MANIFEST = {
  ...
  notes: [
    "Hindi-only backend fix — chat/WhatsApp reply Hindi Devanagari te ashbe, Bangla/Banglish fallback bondho",
    "Installer wizard — path select, desktop shortcut, Start Menu shortcut, startup prompt enabled",
